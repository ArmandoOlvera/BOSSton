...
<?php
  ...
  if(isset($_POST['add_sale'])){
    $req_fields = array('s_id','quantity','price','total', 'date','total2' );
    validate_fields($req_fields);
        if(empty($errors)){
          ...
          $s_date    = make_date();
          $s_total2=$s_total+($s_total*0.16);
          $sql  = "INSERT INTO sales (";
          $sql .= " product_id,qty,price,date,tax";
          $sql .= ") VALUES (";
          $sql .= "'{$p_id}','{$s_qty}','{$s_total}','{$s_date}','{$s_total2}'";
          $sql .= ")";
